...
function Schedule() {
    ...
    return (
        <>
            <Dialog title="Example Modal" onClose={onClose} onOk={onOk} okButton>
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Veniam, quia! Laudantium nulla voluptatum voluptates quod quae. Neque, adipisci! Libero assumenda hic atque illo beatae facilis cumque omnis, autem eveniet. Officia!</p>
            </Dialog>

            <h1 className="text-5xl">Home</h1>

            <Link href="/dashboard" className="text-3xl underline">Go to Home</Link>
